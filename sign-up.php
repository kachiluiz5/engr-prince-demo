        ...
        <div class="max-w-464-px mx-auto w-100">
            ...
            <form action="#">
                <div class="icon-field mb-16">
                    ...
                    <input type="text" class="form-control h-56-px bg-neutral-50 radius-12" placeholder="Device Hardware Number">
                </div>
                <div class="icon-field mb-16">
                    <span class="icon top-50 translate-middle-y">
...
<!-- Mirrored from wowdash.wowtheme7.com/demo/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Aug 2024 13:56:56 GMT -->
</html>
