...
<main class="dashboard-main">
  ...
  <h6 class="fw-semibold mb-0">WEEF Device Dashboard</h6> 
  <button style="border: 0; padding: 10px 10px; background-color: blue; color: white; border-radius: 5px;">Sell Carbon Credit</button>
  <button style="border: 0; padding: 10px 10px; background-color: red; color: white; border-radius: 5px;">Convert Fund</button>
        ...
        <div class="card h-100">
          <div class="card-body">
            <div class="d-flex flex-wrap align-items-center justify-content-between">
              <h6 class="text-lg mb-0">Value of Total Carbon Captured</h6>
            ...
            <div class="d-flex flex-wrap align-items-center gap-2 mt-8">
              ...
              <span class="text-xs fw-medium">+ $100 per PPM</span>
            </div>
      ...
      <div class="col-xxl-3 col-xl-6">
        <div class="card h-100 radius-8 border">
          <div class="card-body p-24">
              <h6 class="mb-12 fw-semibold text-lg mb-16">Daily Carbon Capture</h6>
        ...
        <div class="card h-100 radius-8 border-0 overflow-hidden">
          <div class="card-body p-24">
            <div class="d-flex align-items-center flex-wrap gap-2 justify-content-between">
              <h6 class="mb-2 fw-bold text-lg">Device Overview</h6>
              <div class="">
            ...
            <ul class="d-flex flex-wrap align-items-center justify-content-between mt-3 gap-3">
              <li class="d-flex align-items-center gap-2">
                  ...
                  <span class="text-secondary-light text-sm fw-normal">In Use: 
                      <span class="text-primary-light fw-semibold">7hrs</span>
                  </span>
              </li>
              <li class="d-flex align-items-center gap-2">
                  <span class="w-12-px h-12-px radius-2 bg-yellow"></span>
                  <span class="text-secondary-light text-sm fw-normal">Mining:  
                      <span class="text-primary-light fw-semibold">10hrs</span>
                  </span>
              </li>
            </ul>
...
<!-- Mirrored from wowdash.wowtheme7.com/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Aug 2024 13:55:05 GMT -->
</html>